...
t = TECH(total_impact_hours=i.total_impact_hours,
         ...
         config=config_bounds.test_hatch['tech'])

# Hatch
cstk_data = read_cstk_data()

# DandelionVoting
dandelion = DandelionVoting(17e6,config=config_bounds.test_hatch['dandelion_voting'])
